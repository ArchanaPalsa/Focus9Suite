...
*/
	...
	@FindBy(xpath="//*[text()='Login']")//*[@id="ShowAuthForCreateRestore"]/div/div/div[4]/button[1]
...

	{
		...
		Runtime.getRuntime().exec(getBaseDir()+"\\autoIt\\scripts\\UserRestrictionsBackup.exe");
		...
		String expAlertTxt = "Restore company code : 0A0";
