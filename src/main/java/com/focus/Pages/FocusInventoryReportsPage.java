...
public class FocusInventoryReportsPage extends BaseEngine {
	...
	public static boolean checkStockLedgerReport() throws InterruptedException
	{
		...
		String expAllDatapage1 = "[A1 A101, A2 A102]";
		...
		String expAllDatapage2 = "[APPLE APP001, B1 B201, B2 B202]";
		...
		String expAllDatapage3 = "[D1 D401, D2 D402]";
	...
	public static boolean checkOpeningStockRegisterReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[D2, 1.00, 1.00, 1.00, dds15, D2]";
		...
		String expRow4List = "[B2, 1.00, 1.00, 1.00, BIN1-1.00, D2]";
		...
		String expRow5List = "[APPLE, 1.00, 1.00, 1.00, ASA, D2]";
		...
		String expRow6List = "[A1, 1.00, 1.00, 1.00, BIN1-1.00, D2]";
		...
		String expRow7List = "[B1, 1.00, 1.00, 1.00, BIN1-1.00, D2]";
	...
	public static boolean checkStockStatementReport() throws InterruptedException
	{
		...
		String actAllDatapage1 = AllDatapage1.toString();
		String expAllDatapage1 = "[APPLE APP001, A1 A101, A2 A102, B1 B201, B2 B202, D1 D401]";
		...
		String actAllDatapage2 = AllDatapage2.toString();
		String expAllDatapage2 = "[D2 D402]";
	...
	public static boolean checkStockValuationReportByProductByInventoryTag() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[APPLE, APPLE, APPLE, A, A1, A1, A2, A2, A1, B, B2, B1, B1, B2, D]";
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[A1, D2, HYD, A1, D2, D2, HYD, HYD, A1, A1, D2, D2, A1]";
		...
		String exppage2Row1List = "[D1, D1, D2, D1]";
		...
		String exppage2Row8List = "[A1, D2, D2, HYD]";
	...
	public static boolean checkStockValuationReportByInventoryByProduct() throws InterruptedException
	{
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[A1, A1, A1, A1, A1, A1, D2, D2, D2, D2, D2, D2, D2, HYD]";
		...
		String actpage2Row1List = reportspage2Row1ListArray.toString();
		String exppage2Row1List = "[A2, APPLE, D1]";
		...
		String actpage2Row8List = reportspage2Row8ListArray.toString();
		String exppage2Row8List = "[HYD, HYD, HYD]";
	...
	public static boolean checkStockValuationByFATagReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[APPLE, A1, A2, B1, B2, D1, D2, A1, APPLE, A1, A2, B1, B2, D1, D2, D2]";
	...
	public static boolean checkStockAgeingAnalysisByRMAReport() throws InterruptedException
	{
		...
		String actRow1List = reportsRow1ListArray.toString();
		String expRow1List = "[D1 D401, 51515151, D1-1, D1-10, D1-3, D1-4, D1-5, D1-6, D1-7, D1-8, D1-9, D2 D402, 151, 4, dds15]";
	...
	public static boolean checkStockBalanceByWarehouse() throws InterruptedException
	{
		...
		String actpage2Row1List = reportspage2Row1ListArray.toString();
		String exppage2Row1List = "[APPLE, A1, A2, B1, B2, D1, D2]";
	...
	public static boolean checkTransactionTypeWiseStockReport() throws InterruptedException
	{
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[Grand Total, 31.00, 31.00, 7.00, 7.00, 7.00, 28.00, 28.00, 1.00, 1.00, 1.00, 1.00, 7.00, 7.00, 1.00, 1.00, 1.00, 1.00]";
	...
	public static boolean checkActualConsumptionReport() throws InterruptedException
	{
		...
		String actRow2List = reportsRow2ListArray.toString();
		String expRow2List = "[A1, 1.00, 1.00, 3.00, 3.00, 1.00, 1.00, 1.00, 1.00, 4.00, 16.00, 1.00, 1.00, 1.00, 11.00, 11.00]";
		...
		String actRow8List = reportsRow8ListArray.toString();
		String expRow8List = "[Grand Total, 7.00, 7.00, 28.00, 28.00, 1.00, 1.00, 1.00, 1.00, 7.00, 21.00, 1.00, 1.00, 29.00, 5.22, 15.00]";
