...
public class AccountPropertiesPage extends BaseEngine {
	    ...
	    public static WebElement homeMenu;
		    ...
		    public static WebElement mastersMenu;
				...
				//Setting Elements 
					...
					private static WebElement cancelButton;
					 ...
					 @FindBy (xpath="//div[@id='ReIndexingError_Modal']/div/div")//div[@id='ReIndexingError_Modal']/div/div
			...
			private static List<WebElement> masterGridBodyChkbox;
			  ...
			  @FindBy(xpath="//*[@id='60']/div")
				...
				public  static boolean  newMethod() throws InterruptedException
				{
					CreateAccountInAccountMaster(nameTxt,"cust_display_dr/cr_total_for_each_month1",codeTxt,"CustCrDrTotals2",accountTypeDropdown,"Customer",saveBtn,closeBtn);
					return true;
				}
	...
	public static void CheckSavePurchasesVoucher(String date,String purAcc,String VenAcc, String Warehouse, String dept,String item,String quantity,String rate) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
	...
	public static boolean checkPurchasesVoucherVATForCustomerDislayDrOrCrTotalsForEachMonth() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		CheckSavePurchasesVoucher("20/01/2021","Purchase","cust_display_dr/cr_total_for_each_month","HYDERABAD","DUBAI","STD RATE COGS ITEM","3","300");
	...
	public static boolean checkLedgerReportForCreatedCustomer() throws InterruptedException
	{
		...
		String expRow2List = "[, January 2021, 210.00, 900.00, 690.00, 14.70, 63.00, 48.30, 210.00, 900.00, 690.00, ]";
		...
		String expRow3List = "[, February 2021, 42.00, , 648.00, 2.94, , 45.36, 42.00, , 648.00, ]";
		...
		String expRow4List = "[Total, , , 252.00, 900.00, 648.00, 17.64, 63.00, 45.36, 252.00, 900.00, 648.00, ]";
	...
	public static boolean checkCustomerStatementsReportForCreatedCustomerAccount() throws InterruptedException
	{
		...
		String actRow2List = reportsByWarehouseRow2ListArray.toString();
		String expRow2List = "[PurVou:1, 20/01/2021, cust_display_dr/cr_total_for_each_month, 900.00, , , 900.00, 900.00, 900.00, , , 900.00, Delay In Payment, Indian Rupees, 20/01/2021, CustCrDrTotals, DUBAI, DUBAI]";
		...
		String actRow3List = reportsByWarehouseRow3ListArray.toString();
		String expRow3List = "[NDT55:1, 28/01/2021, cust_display_dr/cr_total_for_each_month, 210.00, , , 210.00, 690.00, 210.00, , , 210.00, Delay In Payment, Indian Rupees, 28/01/2021, CustCrDrTotals, INDIA, INDIA]";
		...
		String actRow4List = reportsByWarehouseRow4ListArray.toString();
		String expRow4List = "[NDT55:2, 28/02/2021, cust_display_dr/cr_total_for_each_month, 42.00, , , 42.00, 648.00, 42.00, , , 42.00, Delay In Payment, Indian Rupees, 28/02/2021, CustCrDrTotals, INDIA, INDIA]";
		...
		String expRow5List = "[Total, , , 648.00, , , 648.00, 2238.00, 648.00, , , 648.00, Delay In Payment, , , , , ]";
	...
	public static boolean checkPurchasesVoucherVATForCustomerDislayDrOrCrTotalsForDay() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		CheckSavePurchasesVoucher("21/01/2021","Purchase","cust_display_dr/cr_total_for_each_day","HYDERABAD","DUBAI","STD RATE COGS ITEM","3","300");
	...
	public static boolean checkLedgerReportForCreatedCustomer2() throws InterruptedException
	{
		...
		String actRow3List = reportsByWarehouseRow3ListArray.toString();
		String expRow3List = "[21/01/2021, PurVou : 2, Purchase, , 900.00, 900.00, , 63.00, 63.00, , 900.00, 900.00, Indian Rupees]";
		...
		String actRow4List = reportsByWarehouseRow4ListArray.toString();
		String expRow4List = "[21/01/2021, , , 900.00, , , 63.00, , , 900.00, , ]";
		...
		String expRow6List = "[28/01/2021, NDT55 : 3, Sales - Computers, 210.00, , 690.00, 14.70, , 48.30, 210.00, , 690.00, Indian Rupees]";
		...
		String expRow7List = "[28/01/2021, , 210.00, , , 14.70, , , 210.00, , , ]";
		...
		String expRow9List = "[28/02/2021, NDT55 : 4, Sales - Computers, 210.00, , 480.00, 14.70, , 33.60, 210.00, , 480.00, Indian Rupees]";
		
		
		
		
		int reportsByWarehouseRow10ListCount = reportsRow10List.size();
		ArrayList<String> reportsByWarehouseRow10ListArray = new ArrayList<String>();
		for(int i=2;i<reportsByWarehouseRow10ListCount;i++)
		{
			String data = reportsRow10List.get(i).getText();
			reportsByWarehouseRow10ListArray.add(data);
		}
		String actRow10List = reportsByWarehouseRow10ListArray.toString();
		String expRow10List = "[28/02/2021, , 210.00, , , 14.70, , , 210.00, , , ]";
		
		
		
		int reportsByWarehouseRow11ListCount = reportsRow11List.size();
		ArrayList<String> reportsByWarehouseRow11ListArray = new ArrayList<String>();
		for(int i=1;i<reportsByWarehouseRow11ListCount;i++)
		{
			String data = reportsRow11List.get(i).getText();
			reportsByWarehouseRow11ListArray.add(data);
		}
		String actRow11List = reportsByWarehouseRow11ListArray.toString();
		String expRow11List = "[Total, , , 420.00, 900.00, 480.00, 29.40, 63.00, 33.60, 420.00, 900.00, 480.00, ]";
		...
		System.out.println("ActualRow9List Values  " +actRow9List);
		System.out.println("ExpectedRow9List Values" +expRow9List);
		
		
		System.out.println("ActualRow10List Values  " +actRow10List);
		System.out.println("ExpectedRow10List Values" +expRow10List);
		
		
		System.out.println("ActualRow11List Values  " +actRow11List);
		System.out.println("ExpectedRow11List Values" +expRow11List);
		...
		if (actRow1List.equalsIgnoreCase(expRow1List) && actRow2List.equalsIgnoreCase(expRow2List) 
				...
				&& actRow9List.equalsIgnoreCase(expRow9List) && actRow10List.equalsIgnoreCase(expRow10List) && actRow11List.equalsIgnoreCase(expRow11List))
		{
			return true;
		} 
		else
	...
	public static boolean checkCustomerStatementsReportForCreatedCustomerAccount2() throws InterruptedException
	{
		...
		String actRow2List = reportsByWarehouseRow2ListArray.toString();
		String expRow2List = "[PurVou:2, 21/01/2021, cust_display_dr/cr_total_for_each_day, 900.00, , , 900.00, 900.00, 900.00, , , 900.00, Delay In Payment, Indian Rupees, 21/01/2021, CustCrDrTotalsDay, DUBAI, DUBAI]";
		...
		String actRow3List = reportsByWarehouseRow3ListArray.toString();
		String expRow3List = "[NDT55:3, 28/01/2021, cust_display_dr/cr_total_for_each_day, 210.00, , , 210.00, 690.00, 210.00, , , 210.00, Delay In Payment, Indian Rupees, 28/01/2021, CustCrDrTotalsDay, INDIA, INDIA]";
		...
		String actRow4List = reportsByWarehouseRow4ListArray.toString();
		String expRow4List = "[NDT55:4, 28/02/2021, cust_display_dr/cr_total_for_each_day, 210.00, , , 210.00, 480.00, 210.00, , , 210.00, Delay In Payment, Indian Rupees, 28/02/2021, CustCrDrTotalsDay, INDIA, INDIA]";
		...
		String actRow5List = reportsByWarehouseRow5ListArray.toString();
		String expRow5List = "[Total, , , 480.00, , , 480.00, 2070.00, 480.00, , , 480.00, Delay In Payment, , , , , ]";
    ...
    public static boolean checkPurchasesVoucherVATForCustomerAccountAsDisplayUnRealizeGainLossInLedger() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
	
	CheckSavePurchasesVoucher(getCurrentDateF2(),"Purchase","Display_Un-Realize_GainOrLoss_In_Ledger","HYDERABAD","DUBAI","STD RATE COGS ITEM","3","300");
...
@FindBy(xpath="//*[@id='tdSort_2_col_Date_']")
private static WebElement sl_2ndRow3rdCol;

	 
	 public boolean checkLedgerReportForCustomerAccountAsDisplayUnRealizeGainLossInLedger() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException, ParseException
	 {
		 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(financialsMenu));
			financialsMenu.click();
			...
			for (int i = 0; i < rowcount; i++) 
			{
		 	...
		 	String expRow2List = "["+currentdate+", PurVou : 3, Purchase, , 900.00, 900.00, , 63.00, 63.00, , 900.00, 900.00, Indian Rupees]";
		 	...
		 	String expRow3List = "["+currentdate+", NDT55 : 5, Sales - Computers, 200.00, , 700.00, 200.00, , 137.00, 10.00, , 890.00, United Arab Emirates Dirham]";
		 	...
		 	String expRow4List = "["+currentdate+", Rct : 1, Bank, , 200.00, 900.00, , 200.00, 63.00, , 12.00, 902.00, United Arab Emirates Dirham]";
		 	...
		 	String expRow5List = "[Total, , , 200.00, 1,100.00, 900.00, 200.00, 263.00, 63.00, 10.00, 912.00, 902.00, ]";
	...
	// Consolidate when both Accounts are same
		...
		private static WebElement  billRefGridAmountRow3;
		 ...
		 public boolean checkSavingRecepitsVocherForValidatingConsolidateWhenBothAccountsAreSame2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		 {
				getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(finacinalsMenu));
				finacinalsMenu.click();
			...
			public boolean checkLedgerReportForConsolidateWhenBothAccountsAreSame() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
			{
				...
				String actRow4List = report4thRowListArray.toString();
				String expRow4List = "[Rct : 3, Customer A, 400.00, , 1,000.00, 28.00, , 70.00, 400.00, , 1,000.00, Indian Rupees]";
				...
				String actRow5List = report5thRowListArray.toString();
				String expRow5List = "[Rct : 3, Customer B, 200.00, , 1,200.00, 14.00, , 84.00, 200.00, , 1,200.00, Indian Rupees]";
	 ...
	 public boolean checkSavingRecepitsVocherForValidatingConsolidateAlways() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	 {
		...
		public boolean checkLedgerReportForConsolidateAlways() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			...
			String actRow2List = report2ndRowListArray.toString();
			String expRow2List = "[Rct : 4, Customer C, 600.00, , 600.00, 42.00, , 42.00, 600.00, , 600.00, Indian Rupees]";
		...
		public static boolean checkPurchasesVoucherVATForCustomerAccountOneInGroup() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
		{
			CheckSavePurchasesVoucher(getCurrentDateF2(),"Purchase","cust-club trans of all accts One","HYDERABAD","DUBAI","STD RATE COGS ITEM","2","200");
		...
		/////////////////////////////////////////
		public static boolean checkLedgerReportForGroupAccountCustCulbTransactionsOfAllAccountsUnderGroup() throws InterruptedException
		{
		...
		public static boolean checkPurchasesVoucherVATForCustomerAccountOneInGroupForDrOrCrTotlas() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
		{
			CheckSavePurchasesVoucher(getCurrentDateF2(),"Purchase","Cust-display cr dr total each account one","HYDERABAD","DUBAI","STD RATE COGS ITEM","2","200");
		...
		//////////////////////////////////////////////////////////
		public static boolean checkLedgerReportForGroupAccountDisplayDrOrCrTotalsForEachAccountUnderGroup() throws InterruptedException
		{
		...
		return false;
		 ...
		 public static void CreateAccountInAccountMaster(WebElement Element,String name, WebElement Element2, String code,WebElement Element3,String visibleTxt, WebElement Element4, WebElement Element5) throws InterruptedException
		    {
		    	Thread.sleep(2500);
		    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(homeMenu));
		    	homeMenu.click();
		    	...
		    	Element2.sendKeys(code);
		    	Element2.sendKeys(Keys.TAB);


		    	Select accountTypeDrpdwn = new Select(Element3);

		    	accountTypeDrpdwn.selectByVisibleText(visibleTxt);
		    	Thread.sleep(2000);
		    	Element4.click();
