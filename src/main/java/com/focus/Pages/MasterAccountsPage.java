...
public class MasterAccountsPage extends BaseEngine
{
	    //Home Menu
	    ...
	    public static WebElement homeMenu;
			...
			@FindBy(xpath="//a[@class='clsMasterName'][contains(text(),'Customer Update Group')]")//*[@id="83"]/a[2]
		   ...
		   //Master------>Delete Field
			...
			private static WebElement masterFieldsOption;
				...
				private static WebElement settingOption;
					...
					/*	@FindBy(xpath="//div[@id='tabId_69']//span[@class='font-5'][contains(text(),'Header Details')]")//*[@id="masterFields_list"]/li[2]/span
				...
				/*	@FindBy(xpath="//div[@id='tabId_70']//span[@class='font-5'][contains(text(),'Header Details')]")
					private static WebElement detailsHeaderDetailsTab;
									  ...
									  @FindBy(xpath="//div[@id='tabId_71']//tbody[@class='ui-sortable']//tr[1]//td[4]")
									  private static WebElement detailsHeaderAddress;
									  ...
									  @FindBy(xpath="//div[@id='tabId_70']//tr[9]//td[4]")//*[@id="HeaderDetails_2"]/div/div/table/tbody/tr[7]/td[4]
									  private static WebElement detailsHeaderSendEmailToCustomer;
					...
					/*	 @FindBy(xpath="//div[@id='tabId_71']//span[@class='font-5'][contains(text(),'Header Details')]")
						 ...
						 @FindBy(xpath="//div[@id='tabId_72']//span[@class='font-5'][contains(text(),'Header Details')]")
							private static WebElement detailsHeaderDetailsTab;
						...
						/* @FindBy(xpath="//div[@id='tabId_71']//tbody[@class='ui-sortable']//tr[1]//td[4]")
						 ...
						 /* @FindBy(xpath="//div[@id='tabId_71']//tr[2]//td[4]")
						  private static WebElement detailsHeaderTelNo;
						  									    
						  @FindBy(xpath="//div[@id='tabId_71']//tr[3]//td[4]")
						  private static WebElement detailsHeaderFaxNo;		
						                  
						  @FindBy(xpath="//div[@id='tabId_71']//tr[4]//td[4]")
						  private static WebElement detailsHeaderCity;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[5]//td[4]")
						  private static WebElement detailsHeaderPin;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[6]//td[4]")
						  private static WebElement detailsHeaderDeliveryAddress;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[7]//td[4]")
						  private static WebElement detailsHeaderCityOne;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[8]//td[4]")
						  private static WebElement detailsHeaderPinOne;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[9]//td[4]")//*[@id="HeaderDetails_2"]/div/div/table/tbody/tr[7]/td[4]
						  private static WebElement detailsHeaderSendEmailToCustomer;
				
						  @FindBy(xpath="//div[@id='tabId_71']//tr[10]//td[4]")
						  private static WebElement detailsHeaderAllowCustomerPortal;
						  
						  @FindBy(xpath="//div[@id='tabId_71']//tr[11]//td[4]")
						  private static WebElement detailsHeaderEmail;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[12]//td[4]")
						  private static WebElement detailsHeaderPassword;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[13]//td[4]")
						  private static WebElement detailsHeaderBankAccountName;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[14]//td[4]")
						  private static WebElement detailsHeaderBankAccountNumber;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[15]//td[4]")
						  private static WebElement detailsHeaderIFSCCode;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[16]//td[4]")
						  private static WebElement detailsHeaderPaymentType;

						  @FindBy(xpath="//div[@id='tabId_71']//tr[17]//td[4]")
						  private static WebElement detailsHeaderFinanceEmail;							  
				
                         @FindBy(xpath="//div[@id='tabId_71']//tr[18]//td[4]")
						  private static WebElement detailsHeaderPortalEmail;*/
                        ...
                        @FindBy(xpath="//div[@id='tabId_72']//tr[18]//td[4]")
						  private static WebElement detailsHeaderPortalEmail;
							...
							private static WebElement detailsBodyDetailsTab;*/
							 ...
							 @FindBy(xpath="//div[@id='tabId_72']//span[@class='font-5'][contains(text(),'Body Details')]")
							private static WebElement detailsBodyDetailsTab;
				...
				@FindBy(xpath="//*[@id='masterFields_list']/li[4]/span")//*[@id="masterFields_list"]/li[4]/span
				...
				/* @FindBy(xpath="//div[@id='tabId_72']//span[@class='font-5'][contains(text(),'Header Details')]")
				 ...
				 @FindBy(xpath="//div[@id='tabId_73']//span[@class='font-5'][contains(text(),'Header Details')]")
				  private static WebElement printlayoutHeaderDetailsTab;
	...
	public static boolean checkOpenAccountsMenu() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
    ...
    /*	boolean actdashboardGraph     =dashboardGraph.isDisplayed();
	   ...
	   /* System.out.println("Dashboard Graph isDisplayed      : "+actdashboardGraph      +"  value expected  "+expdashboardGraph);
	    ...
	    System.out.println("Title                            : "+actAccountsTitle       +"  value expected  "+expAccountsTitle);
		...
		if(userInfo.equalsIgnoreCase(expuserInfo) && getLoginCompanyName.equalsIgnoreCase(expLoginCompanyName)/* &&
	    	...
	    	actAccountsTitle.equalsIgnoreCase(expAccountsTitle))
		{	
	...
	public static boolean checkAccountsCreationScreenAfterSavingBeforeCustomization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
	 ...
	 private static List<WebElement> accontsCheckBoxList;
	...
	public static boolean checkEditOptionForNewlyCreateAccountBeforeCustomization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			...
		 			if(data.equalsIgnoreCase("Trail Account"))     
		 			{
		 				accontsCheckBoxList.get(i).click();
		 				break;
		 			}
		 		}
	...
	public static boolean checkAccountAddGroupNewCreateDisplayInAccountGrid() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		int accountsCount = accontsNameList.size();
		 boolean customerGroupAccount = false;
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			 String data = accontsNameList.get(i).getText();
		 			accountslist.add(data);
		 			if(data.equalsIgnoreCase("Customer Group"))     
		 			{
		 				customerGroupAccount = true;
		 				break;
		 			}
		 		}
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			...
		 			if(data.equalsIgnoreCase("Customer Update Group"))     
		 			{
		 				...
		 				WebElement checkBox = accontsCheckBoxList.get(i);
	...
	public static boolean checkCloneOptionWithoutRowSelectToOpenAccountsMenu() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		int accountsCount = accontsNameList.size();
		 boolean customerUpdateGroup = false;
		...
		int accountsCount = accontsNameList.size();
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			 String data = accontsNameList.get(i).getText();
		 			accountslist.add(data);
		 			if(data.equalsIgnoreCase("Customer Display CD For Each Account Two"))     
		 			{
		 				customerAccount = true;
		 				break;
		 			}
		...
		String expaccountNewCreationName  ="Customer Display CD For Each Account Four"; */
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			 String data = accontsNameList.get(i).getText();
		 			accountslist.add(data);
		 			if(data.equalsIgnoreCase("Customer Display CD For Each Account Four"))     
		 			{
		 				customerAccount = true;
		 				break;
		 			}
 	...
 	public static boolean checkDeleteAccountDisplay() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		String expaccountNewCreationName  ="Customer Display CD For Each Account Three";*/
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		System.out.println("Account List: "+customerAccount);
	...
	*/
 	      ...
 	      /*  getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterCreationNameOfLane1));
			 ...
			 ArrayList<String> accountslist = new ArrayList<String>();
			 		...
			 		for (int i = 0; i < accountsCount; i++)
			 		{
			 			 String data = accontsNameList.get(i).getText();
			 			accountslist.add(data);
			 			if(data.equalsIgnoreCase("COGS POSTING ACC") &&  data.equalsIgnoreCase("BR COGS ACC INV")
			 					&& data.equalsIgnoreCase("FIFO COGS ACC INV") && data.equalsIgnoreCase("WA COGS ACC INV")
			 					 && data.equalsIgnoreCase("STD RATE COGS ACC INV") && data.equalsIgnoreCase("SR COGS POSTING ACC")
			 					&& data.equalsIgnoreCase("SHORTAGE COGS POSTING ACC") && data.equalsIgnoreCase("EXCESS COGS POSTING ACC")) 
			 			{
			 		...
			 		String actmasterGridBodyList=accountslist.toString();
			 		String expmasterGridBodyList= "[COGS POSTING ACC, BR COGS ACC INV, FIFO COGS ACC INV, WA COGS ACC INV,"
			 				+ " STD RATE COGS ACC INV, SR COGS POSTING ACC, SHORTAGE COGS POSTING ACC, EXCESS COGS POSTING ACC]";*/
 			...
 			/*int accountsCount = accontsNameList.size();
 			 ...
 			 ArrayList<String> accountslist = new ArrayList<String>();
 			 		...
 			 		for (int i = 0; i < accountsCount; i++)
 			 		{
 			 			 String data = accontsNameList.get(i).getText();
 			 			accountslist.add(data);
 			 			if(data.equalsIgnoreCase("VAT OUTPUT") && data.equalsIgnoreCase("VAT ADVANCE SALE") &&
 			 					data.equalsIgnoreCase("VAT ADVANCE PURCHASE") && data.equalsIgnoreCase("PURCHASE VARIANCE"))     
 			 			{
 			 		...
 			 		String actmasterGridBodyList=accountslist.toString();
 			 		String expmasterGridBodyList= "[VAT OUTPUT, VAT ADVANCE SALE, VAT ADVANCE PURCHASE, PURCHASE VARIANCE]";
 			*/
 	...
 	public static boolean checkCloseAccountMasterForAccountTestingStop() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
     ...
     public MasterAccountsPage(WebDriver driver)
     {
