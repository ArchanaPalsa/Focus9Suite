...
public class WareHouseCodeIncrementPage extends BaseEngine {
		...
		public static boolean checkSaveNormalIncrementInWarehouseCode() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{	
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(WgeneralMainTab));
			WgeneralMainTab.click();
			...
			Thread.sleep(2000);
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(headerDetailswarehouseSaveBtn));
			headerDetailswarehouseSaveBtn.click();
		...
		public static boolean checkSavedWarehouseMastersWithIncrement() throws InterruptedException
		{
		...
		public static boolean checkSaveCopyFromParentAndIncrementalForGroupWarehouse() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
		...
		public static boolean checkSaveGroupWarehousesAndNestedGroupWarehousesAndVerfifyCode() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
		{
		...
		public static boolean checkSaveNormalWarehouseInLevelOne() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			Thread.sleep(2000);
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(homeMenu));
			homeMenu.click();
			...
			String expSaveWarehouseMessage = "Saved Successfully";	
			String actSaveWarehouseMessage = checkValidationMessage(expSaveWarehouseMessage);
			...
			for (int i = 0; i < codecount; i++) 
			{
				...
				WarehouseCodes.add(data);
			}
			 
			String actCodeText = WarehouseCodes.toString();
			...
			if (actSaveWarehouseMessage.equalsIgnoreCase(expSaveWarehouseMessage) 
		...
		public static boolean checkSaveNormalWarehouseInLevelFour() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
		{
			Thread.sleep(2000);
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(homeMenu));
			homeMenu.click();
		...
		public WareHouseCodeIncrementPage(WebDriver driver)
		{
