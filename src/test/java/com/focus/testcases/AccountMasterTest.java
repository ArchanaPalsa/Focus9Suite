...
public class AccountMasterTest extends BaseEngine 
{
	...
	@Test(priority=4091)// file name receiving not done
	public void checkAdvancedImportOrExportAfterEnablingExportCheckBoxesInCreateTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, AWTException
	{
		cmctp=new AccountMasterPage(getDriver());
	...
	//@Test(priority=7172)//std rate item transactions more 
	...
	@Test(priority=7188)
	public void checkSavePVVATforNotAvailableForReports() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkSavePVVATforNotAvailableForReports(), true);
	}
	...
	@Test(priority=7191)
	public void checkImportedPVVatVoucher() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkImportedPVVatVoucher(), true);
	}
	...
	@Test(priority=7250)
	public void checkCreateViewInAccountMasterandValidateInAccountGridTable() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkCreateViewInAccountMasterandValidateInAccountGridTable(), true);
	}

	@Test(priority=7251)
	public void checkEditCreatedView() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkEditCreatedView(), true);
	}

	@Test(priority=7252)
	public void checkDeleteCreatedView() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkDeleteCreatedView(), true);
	}


	@Test(priority=7253)
	public void checkBackTrackingInAccountLedgerFromRibbonList() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkBackTrackingInAccountLedgerFromRibbonList(), true);
	}


	@Test(priority=7254)
	public void checkPrintInMasterRibbonControl() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		cmctp=new AccountMasterPage(getDriver());
		Assert.assertEquals(cmctp.checkPrintInMasterRibbonControl(), true);
	}
